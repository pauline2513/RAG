...
Streamlit-приложение для вызова LLM с реализацией RAG и без. В качестве модели используется [t-tech/T-lite-it-2.1-GGUF](https://huggingface.co/t-tech/T-lite-it-2.1-GGUF), а именно **Q5_K_M.gguf**. В качестве графа используется результат извлечения информации из таблиц.
